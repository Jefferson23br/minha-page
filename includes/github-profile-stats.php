...
function render_github_profile_stats(array $t, string $username = 'Jefferson23br'): void
{
    ...
    if ($contributions !== null) {
        ...
        $periodLabel = sprintf($t['github_commits_eyebrow'] ?? 'Commits in %s', (string) $year);
        $caption = $t['github_commits_caption'] ?? 'GitHub contributions';
        echo '<div class="github-profile__commits">';
        echo '<p class="github-profile__commits-period">' . e($periodLabel) . '</p>';
        echo '<p class="github-profile__commits-value">' . e($countLabel) . '</p>';
